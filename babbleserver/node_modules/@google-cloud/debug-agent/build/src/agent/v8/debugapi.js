...
var debugApiConstructor;
function willUseInspector(nodeVersion) {
    var version = nodeVersion != null ? nodeVersion : process.version;
    return utils.satisfies(version, '>=10');
}
exports.willUseInspector = willUseInspector;
if (willUseInspector()) {
    var inspectorapi = require('./inspector-debugapi');
    debugApiConstructor = inspectorapi.InspectorDebugApi;
}
else {
    var v8debugapi = require('./legacy-debugapi');
    debugApiConstructor = v8debugapi.V8DebugApi;
}
exports.MODULE_WRAP_PREFIX_LENGTH = require('module').wrap('☃').indexOf('☃');
var singleton;
