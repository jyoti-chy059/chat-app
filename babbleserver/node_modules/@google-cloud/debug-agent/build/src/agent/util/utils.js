...
function findScripts(scriptPath, config, fileStats) {
    ...
    if (config.appPathRelativeToRepository) {
        var candidate = scriptPath.replace(config.appPathRelativeToRepository, config.workingDirectory);
 ...
 */
exports.formatInterval = function (msg, interval) {
...
function satisfies(nodeVersion, semverRange) {
    ...
    var coercedVersion = semver.coerce(nodeVersion);
    var finalVersion = coercedVersion ? coercedVersion.version : nodeVersion;
